...
借助于对一个已有的简单语言处理程序的改进, 学生可对语言处理程序有一个初步的认识, 并且更深入地理解龙书(Dragon Book)第 2 版(DBv2)第 2 章 A Simple Syntax-Directed Translator 的内容。
